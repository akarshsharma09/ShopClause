...
const paymentMethods = [
  { id: 1, name: "Cash on Delivery", value: "COD", icon: <BanknotesIcon className="h-5 w-5 text-gray-500" /> },
  { id: 2, name: "UPI", value: "UPI", icon: <QrCodeIcon className="h-5 w-5 text-green-600" /> },
  { id: 3, name: "Credit/Debit Card", value: "Card", icon: <CreditCardIcon className="h-5 w-5 text-blue-600" /> },
];
